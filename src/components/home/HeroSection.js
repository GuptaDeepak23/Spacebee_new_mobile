            ...
            >
                <View style={[S.heroOverlay, { flex: 1 }]}>
                    ...
                    <View style={S.heroTop}>
                        <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                            <LinearGradient colors={Gradients.avatar} style={S.ava}>
                                <Text style={S.avaTxt}>JM</Text>
                            </LinearGradient>
                            <View style={{ marginLeft: 10 }}>
                                <Text style={S.hiSub}>Hello,</Text>
                                <Text style={S.hiName}>Jamal Musala 👋</Text>
                            </View>
                        </View>
                    </View>
                    ...
                    <Animated.View style={{ opacity: formOpacity }}>
                        <Text style={S.heroTitle}>Which workspace do you{'\n'}want to book?</Text>

                        {/* ── GLASS SEARCH CARD ── */}
                        <View style={S.glassCard}>

                            {/* 1. Branch */}
                            <TouchableOpacity style={S.glassRow} onPress={onBranchPress} activeOpacity={0.8}>
...
const S = StyleSheet.create({
    ...
    glassRow: { flexDirection: 'row', alignItems: 'center', paddingVertical: 10, paddingHorizontal: 12, backgroundColor: 'rgba(255,255,255,0.14)', borderRadius: 14 },
    ...
    glassCaret: { color: 'rgba(255,255,255,0.7)', fontSize: 14 },
